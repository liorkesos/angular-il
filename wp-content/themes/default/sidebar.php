		...
		<ul>
			...
			<?php /* If this is the frontpage */ if ( is_home() || is_page() ) { ?>
				...
				<ul>
					...
					<li><a href="<?php bloginfo('comments_rss2_url'); ?>" title="<?php echo attribute_escape(__('The latest comments to all posts in RSS')); ?>"><?php _e('Comments <abbr title="Really Simple Syndication">RSS</abbr>'); ?></a></li> <?php /* Modified for WPH */ ?>
					...
					<li><a href="http://wph.co.il/" title="<?php _e('Powered by WordPress, state-of-the-art semantic personal publishing platform.', 'kubrick'); ?>">וורדפרס בעברית</a></li> <?php /* Modified for WPH */ ?>
					<?php wp_meta(); ?>
				</ul>
				</li>
			<?php } ?>
