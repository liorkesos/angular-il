<?php // Modified for WPH  (Link to wph.co.il)
/**
 * WordPress User Page
 *
...
<div id="login"><h1><a href="<?php echo apply_filters('login_headerurl', 'http://wph.co.il/'); ?>" title="<?php echo apply_filters('login_headertitle', __('Powered by WordPress')); ?>"><?php bloginfo('name'); ?></a></h1> <?php /* WPH */ ?>
<?php
