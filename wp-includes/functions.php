<?php /* WPH - RTL all error messages 
http://trac.wordpress.org/ticket/6132 */
/**
 * Main WordPress API
 *
 * @package WordPress
...
<html xmlns="http://www.w3.org/1999/xhtml" <?php  if ( function_exists( 'language_attributes' ) ) language_attributes(); ?> dir="rtl"> <?php /* WPH - Makes sure error messages are RTLed even before locale is loaded */ ?>
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title><?php echo $title ?></title>
	<link rel="stylesheet" href="<?php echo $admin_dir; ?>css/install.css" type="text/css" />
<?php /*
if ( ( $wp_locale ) && ( 'rtl' == $wp_locale->text_direction ) ) : */ ?> <?php /* WPH */ ?>
